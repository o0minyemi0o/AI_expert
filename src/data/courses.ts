...
export const courses: Course[] = [
  ...
  // ===== AI ENGINEERING & MLOPS =====
  {
    ...
    shortTitle: "Training",
    description:
      "Data parallelism, model parallelism, pipeline parallelism, mixed precision training, DeepSpeed, FSDP, and efficient training recipes.",
    objectives: [
      "Implement data, model, and pipeline parallelism",
      "Configure mixed precision training (FP16, BF16)",
      "Use DeepSpeed ZeRO stages and FSDP",
      "Design efficient large-model training recipes",
      "Handle checkpointing, fault tolerance, and elastic training",
    ],
    prerequisites: ["deep-learning", "systems-programming"],
    difficulty: "expert",
    estimatedHours: 35,
    lectureCount: 10,
    tags: ["distributed-training", "deepspeed", "fsdp", "mixed-precision"],
    order: 1,
  },
  {
    id: "model-serving",
    ...
    shortTitle: "Serving",
    description:
      "Inference optimization, quantization (GPTQ, AWQ, GGUF), serving infrastructure (vLLM, TensorRT), and A/B model testing.",
    objectives: [
      "Apply quantization techniques (INT8, INT4, GPTQ, AWQ)",
      "Optimize inference with batching, KV caching, speculative decoding",
      "Deploy models with vLLM, TGI, and TensorRT-LLM",
      "Design model serving infrastructure for high throughput",
      "Implement A/B testing and canary deployments for models",
    ],
    prerequisites: ["deep-learning", "software-engineering"],
    difficulty: "expert",
    estimatedHours: 35,
    lectureCount: 10,
    tags: ["quantization", "vllm", "tensorrt", "inference", "deployment"],
    order: 2,
  },
  {
    id: "ml-system-design",
    ...
    description:
      "Feature stores, training pipelines, experiment tracking, model monitoring, feedback loops, and end-to-end ML system architecture.",
    objectives: [
      "Design feature stores for online and offline serving",
      "Architect training pipelines with experiment tracking",
      "Implement model monitoring (data drift, performance decay)",
      "Design feedback loops for continuous model improvement",
      "Solve ML system design interview problems",
    ],
    prerequisites: ["model-serving", "data-pipelines"],
    difficulty: "expert",
    estimatedHours: 40,
    lectureCount: 12,
    tags: ["feature-store", "monitoring", "experiment-tracking", "system-design"],
    order: 3,
  },
